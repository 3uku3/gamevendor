...
function createCard(radio, name, link, description, oldPrice, newPrice) {
...
popupForm.addEventListener('submit', (evt) => {
  evt.preventDefault();
  const cardElement = createCard(popupRadio, popupName, popupLink, popupDescription, popupOldPrice, popupNewPrice);
